<header>
  <div class="container b-header__box b-relative">
    ...
    @if(auth()->guard('admin')->user()||auth()->guard('subadmin')->user())
    ...
    <li class="b-top-nav__1level f-top-nav__1level <?php if($pg==34){echo 'is-active-top-nav__1level';}?> f-primary-b">
        ...
        <div class="b-top-nav__dropdomn">
            <ul class="b-top-nav__2level_wrap">
              ...
              @endif
              @if(auth()->guard('subadmin')->user())
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="{{url('/sadmin/addstd')}}"><i class="fa fa-angle-right"></i>Add New</a></li>
                @endif
              ...
              @endif
              @if(auth()->guard('instructor')->user())
                <li class="b-top-nav__2level f-top-nav__2level f-primary"><a href="{{url('/instr/addstd')}}"><i class="fa fa-angle-right"></i>Add New</a></li>
                @endif
 ...
 @if(!auth()->guard('instructor')->user()&&!auth()->guard('subadmin')->user()&&!auth()->guard('admin')->user())
    ...
    @if(!auth()->guard('instructor')->user()&&!auth()->guard('subadmin')->user()&&!auth()->guard('student')->user()&&!auth()->guard('admin')->user())
            ...
            {{csrf_field()}}
             <div class="form-group">
                ...
                <label class="mm" for="instructor_id">ID: </label>
                   ...
                   <input class="form-control" required="" readonly="" id="mo" value="{{App\Sign::max('instructor_id')+1}}"  name="instructor_id" type="text">        
                 </div>
             </div>
