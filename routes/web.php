...
Route::get('/std/profile/{id}', 'StudentController@my_profile');
...
Route::get('/ainstructor/profile/{id}', 'InstructorController@my_profile');
...
Route::get('/sadmin/instructors', 'AdminController@admin_instructors');
